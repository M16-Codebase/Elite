<?php  return array (
  ...
  'prop_formit.savetmpfiles_desc' => 'If set to 1, FormIt will store submitted files in a temporary folder.',
  'prop_formit.attachfiles_desc' => 'If true, FormIt will add all file fields as attachments in the email.',
);