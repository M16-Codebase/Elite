...
class SimpleXMLReader extends \XMLReader
{
    ...
    private $startItemIterate = false;
    protected $innerId;
    protected $offer;
     ...
     * @return void
     */
    public function parse(XmlLoadFactory $loader)
    {
        ...
        while ($continue && $this->read()) {
            ...
            // старт
            if ($this->name == 'offer' && $this->nodeType == \XMLReader::ELEMENT) {
                $this->startItemIterate = true;
            }
            ...
            if ($this->name == 'offer' && $this->nodeType == \XMLReader::END_ELEMENT) {
                if ($this->startItemIterate) {
                    $loader->loadItem($this->innerId, $this->offer);
                }
                $this->startItemIterate = false;
            }
        }
