...
<div class="main-sc main-sc2 post">
...
<div class="main-sc main-sc3">
  <div class="row">
    <div class="nn_serv"></div>
    <div class="col">
      <a href="{$url_prefix}/service/" class="main-sc3-item">
        <div class="main-sc3-item-pic">
          {fetch file=$path . "heli.svg"}
        </div>
        <div class="main-sc3-item-desc">
			{$lang->get('Личный вертолет', 'Personal copter')}
        </div>
      </a>
    </div>
    <div class="col">
      <a href="{$url_prefix}/service/#tour" class="main-sc3-item">
        <div class="main-sc3-item-pic">
          {fetch file=$path . "investtur.svg"}
        </div>
        <div class="main-sc3-item-desc">
          {$lang->get('Инвест-тур', 'Invest-tour')}
        </div>
      </a>
    </div>
    {*}
    <div class="col">
      ...
      <a href="{$url_prefix}/service/#zalog" class="main-sc3-item">
        <div class="main-sc3-item-pic">
          {fetch file=$path . "zalog.svg"}
        </div>
        <div class="main-sc3-item-desc">
          {$lang->get('Заем под залог', 'Mortgage loan')}
        </div>
      </a>
    ...
    *}
    <div class="col">
      <a href="{$url_prefix}/service/#tradein" class="main-sc3-item">
        <div class="main-sc3-item-pic">
