...
(function ($) {
    $.widget("ui.tagit", {
        ...
        options:{
            ...
            emptySearch:true,
			//
			beforeAdded:function (tagValue, element) {
				;
			},
        ...
        _create:function () {
			...
			//for compatibility with jquery ui 1.9
        ...
        _addTag:function (label, value) {
            ...
            var beforeResult = this.options.beforeAdded(label, value);
			if (beforeResult && beforeResult.label) label = beforeResult.label;
			if (beforeResult && beforeResult.value) value = beforeResult.value;
            ...
            tag.element = $('<li class="tagit-choice"'
                ...
                + '<div class="tagit-label">' + label + '</div>' + '<a class="tagit-close"></a></li>');
