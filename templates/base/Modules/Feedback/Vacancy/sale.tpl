...
<div class="contacts-page content-block">
	...
	<div class="order-block">
		<div class="fields-block feedback-block">
			...
			<form enctype="multipart/form-data" action="/hr-feedback/makeRequest/" method="post" class="feedback-form" data-checkstring="{$checkString}" data-hashstring="{md5($checkStringSalt)}">
