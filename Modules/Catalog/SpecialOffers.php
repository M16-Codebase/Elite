...
class SpecialOffers extends CatalogPublic{
    const DEFAULT_CATALOG_KEY = CatalogConfig::SPECIAL_OFFER_KEY;
    const PAGE_SIZE = 12;
    ...
    public function items(){
        ...
        if ($type_id == TypeEntity::DEFAULT_TYPE_ID){
            return $this->redirect($this->getModuleUrl($this->segment['id']));
        }
