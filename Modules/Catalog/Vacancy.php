...
class Vacancy extends CatalogPublic{
    const DEFAULT_CATALOG_KEY = CatalogConfig::VACANCY_KEY;
    const PAGE_SIZE = 12;
    ...
    public function viewItem(){
        ...
        $this->getAns()
            ->add('item', $item)
            ->add('current_type', $type)
            ->add('vacancy_form', \Models\CatalogManagement\Positions\Feedback::getForm('vacancy', array('vacancy' => $item['id'])));
    }
